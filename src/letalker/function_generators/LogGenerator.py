...
class BaseLogGenerator(FunctionGenerator):
    ...
    def __init__(
        ...
        """Log function generator wrapper


        Parameters
        ----------
        antilog
            a function generator to provide the anti-logarithm value.
        base, optional
    ...
    def shape(self) -> tuple[int, ...]:
        ...
        return self._antilog.shape

    @property
    def ndim(self) -> int:
        """number of dimensions of each sample (0 if scalar)"""
        return self._antilog.ndim
    ...
    def __call__(
        ...
        **kwargs,
        ...
        x = self._antilog(n, n0, sample_edges, upsample_factor, **kwargs)
    ...
    def derivative(
        ...
        **kwargs,
        ...
        dx = self._antilog.derivative(*ts_args, nu, **kwargs)
...
class LogGenerator(TaperMixin, BiasMixin, ScaleMixin, BaseLogGenerator):
    ...
    def __init__(
        ...
        *,
        ...
        ----------
        antilog
            a function generator to provide the antilog value
        base, optional
            base of the exponential function, by default None to use the Euler's number e
        scale, optional
    ...
    def __init__(self, antilog: FunctionGenerator, **kwargs):
        super().__init__(antilog=antilog, ScaleBaseClass=BaseLogGenerator, **kwargs)
